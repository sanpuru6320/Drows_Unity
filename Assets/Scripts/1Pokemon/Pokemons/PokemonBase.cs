...
public class PokemonBase : ScriptableObject
{
    ...
    public List<MoveBase> LearnableByItem => learnableByItems;
...
{
    [SerializeField] PokemonBase evolutionInto;
    [SerializeField] int requiredLevel;
    //[SerializeField] EvolutionItem requiredItem;

    public PokemonBase EvolvesInto => evolutionInto;
